...
├── farm.html         The Farm (crops + livestock + Built by Hand workshop)
├── captain.html      The Captain of Negros
├── workshop.html     Redirects to farm.html#workshop
├── farm-learning.html Farm Learning (student visits + photo gallery)
...
The main nav contains Home, About, The Farm, The Captain, Farm Learning, Products,
Vlogs, Gallery, Partners, Press, and Contact. Workshop content is embedded inside The Farm
page to keep the navigation focused. Contact remains a normal menu item, not a button.
...
### Updating this release in an existing Supabase project

This package adds the homepage social-audience row, partner collaboration gallery,
student-visit gallery updates, and the merged Workshop/Farm structure. If the live site
already reads from Supabase, run `supabase/seed_content.sql` again **or** update and save
the matching fields through `/admin/`. Supabase content takes priority over
`data/content.json`.
...
- **Sidebar** — every editable section: Hero, Announcements, Home Teasers, About,
  The Captain of Negros, The Farm (crops + livestock), Built by Hand / Workshop,
  Farm Learning, Planting Materials & Tools, Vlogs, Gallery, Partners & Sponsors, Press, Contact,
