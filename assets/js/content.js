...
(function () {
  ...
  "social": {
    ...
    "tiktok": "https://www.tiktok.com/@king.ofalltrade",
  ...
  "hero": {
    ...
    "titleLine1": "Solomon",
    "titleLine2": "Pagunsan",
    "tagline": "The Captain of Negros • Farmer • Innovator • Educator",
    "lede": "A self-made farmer whose field experience now reaches students, farmers, buyers, and viewers nationwide — from sugarcane fields to practical farm innovations.",
  ...
  "homeTeasers": [
    {
      ...
      "text": "The full story behind the name, the influence, and the public personality people recognize across Negros.",
      "href": "captain.html",
      "linkLabel": "Read the story"
    },
    {
      "title": "Farm Learning",
      "text": "A working farm that became a practical learning site for agriculture students.",
      "href": "farm-learning.html",
      "linkLabel": "See student learning"
    },
    {
      "title": "The Farm",
      "text": "Sugarcane, cassava, corn, carabao, livestock, and the systems that keep the land productive.",
      "href": "farm.html",
      "linkLabel": "Explore the farm"
    },
    {
      "title": "Built by Hand",
      "text": "Field tools and modifications built by hand to solve real farming problems.",
      "href": "farm.html#workshop",
      "linkLabel": "See farm innovations"
    },
    {
      "title": "Planting Materials & Tools",
      "text": "Cassava cuttings, Napier cuttings, sugarcane setts, and modified tools supplied by inquiry nationwide.",
      "href": "products.html",
      "linkLabel": "View materials"
    },
    {
      "title": "Vlogs",
      "text": "Practical farming, daily work, community life, and field documentation.",
      "href": "vlogs.html",
  ...
  "captain": {
    ...
    "reach": {
      ...
      "youtubeSubscribers": "1.02K",
      "tiktokFollowers": "14.8K",
      "monthlyReach": "",
      "note": "Audience figures change over time and can be updated from the CMS.",
      "facebookSecondaryFollowers": "238K"
    },
    "persona": {
  ...
  "farmLearning": {
    ...
    "title": "The farm as a real classroom",
    "intro": "Although Solomon Pagunsan did not attend college, his real-world farming experience has become a valuable learning resource for agriculture students. Students visit his farm to observe practical techniques, ask field questions, and learn directly from years of hands-on work.",
    "points": [
      {
  ...
  "partners": {
    ...
    "supporters": [
      {
        ...
        "text": "Planting materials, feed, and farm inputs that keep the operation running."
      },
      {
    ...
    "gallery": {
      "kicker": "Partnerships in Action",
      "title": "Working together, on and beyond the farm",
      "intro": "Selected moments from sponsor collaborations, product activities, events, and community partnerships with Solomon.",
      "items": [
        {
          "img": "images/Sponsor_1.jpg",
          "partner": "JI Telecom",
          "caption": "A partner collaboration with Solomon.",
          "active": true
        },
        {
          "img": "images/Sponsor_3.jpg",
          "partner": "MMTT Laptop Services",
  ...
  "homeAuthority": {
    "kicker": "Solomon Pagunsan",
    "title": "Farmer. Innovator. Teacher by experience.",
    "lead": "Built from daily fieldwork, Solomon’s story connects farming, practical invention, student learning, and community influence.",
    "cards": [
      {
        "title": "Farmer",
        "text": "A working farm shaped by hands-on experience in crops, livestock, and daily field operations.",
        "href": "farm.html"
      },
      {
        "title": "Innovator",
        "text": "Tools and methods modified to solve real problems in the field.",
        "href": "farm.html#workshop"
      },
      {
        "title": "Educator",
        "text": "Agriculture students visit to learn beyond the classroom.",
        "href": "farm-learning.html"
      },
      {
        "title": "Community Figure",
        "text": "Known across Negros for both his farming work and public personality.",
        "href": "captain.html"
      }
    ]
  },
  ...
  "materialsSpotlight": {
    "kicker": "Planting Materials & Tools",
    "title": "Field-tested materials, supplied by inquiry",
    "text": "Cassava cuttings, Napier grass cuttings, sugarcane setts, and modified spading tools are available through direct inquiry, with nationwide delivery subject to stock and arrangement.",
    "image": "images/Napier_1.jpg",
